...
def backgroundSelection(category = None):
    ...
    cityPath = 'Image-lib/background-lib/City/'
    dawnPath = 'Image-lib/background-lib/Dawn/'
    duskPath = 'Image-lib/background-lib/Dusk/'
    nightPath = 'Image-lib/background-lib/Night/'
    lightPath = 'Image-lib/background-lib/Light/'
    darkPath = 'Image-lib/background-lib/Dark/'
