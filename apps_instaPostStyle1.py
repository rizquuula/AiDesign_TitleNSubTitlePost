...
img = drawTitle(fontPath = '/home/linkgish/Desktop/AiDesign_01/Font-lib/Kaushan_Script/KaushanScript-Regular.ttf',
                        fontSize = 400,
...
img = MakeBodyText(image=img,
                        text=typedBodyText,
                        FONT_PATH='/home/linkgish/Desktop/AiDesign_01/Font-lib/Comfortaa/Comfortaa-Bold.ttf',# BodyFont,
                        FONT_SIZE=500,
                        wrap_width=45,
                        padding=10,
                        # isBackRect=True,
...
# savePath = ('/home/linkgish/Desktop/AiDesign_01/Result-lib/Style1 {}.jpg').format(nowTime)
# img.save(savePath)
